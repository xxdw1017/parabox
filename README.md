...
`提交材料/` 下是本次课程作业的交付内容：个人文档（`个人文档_董长坤.html`，浏览器打印为 PDF 即 5 页）、
系统描述（298 字）、提交帖模板、提交步骤（仓库公开与 Release 命名）、压缩包清单、演示视频录制脚本，
以及规则与测试的**逐版导出**（`历史版本/`，9 个文件共 31 个版本）。
可执行程序与演示视频见本仓库的 Releases。
